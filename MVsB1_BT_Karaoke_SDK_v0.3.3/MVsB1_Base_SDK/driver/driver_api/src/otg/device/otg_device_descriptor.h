...
const uint8_t ConfigDescriptor_Tab(MIC_ONLY)[] =
{
	...
	0x0C,0x24,0x02,0x04,0x03,0x02,0x00,0x02,0x03,0x00,0x00,0x00,
...
{
	//No1:Type Configuration;No2~3:sizeof(Tab);No4:totalInterfaceNum;No7:RemoteWakeup/SelfPower;No8:MaxPower
#if HID_DATA_FUN_EN
	//一共4个接口
...
#endif
	//0 audio control Interface
	//No1:Type Interface;No2:INTERFACENUM;No3:AltSet;No4:numendpoint;No5:InterClass:Audio;No6：SubClass：Control
	0x09,0x04,0x00,0x00,0x00,0x01,0x01,0x00,0x00,
	//No1:Type Cs_interface;No5~6:Length; No7:InCollection; No8~9:InterfaceN
	0x0A,0x24,0x01,0x00,0x01,0x4F,0x00,0x02,0x01,0x02,
	//No2:SType Input;No3:TerminalID; No4~5:Type 0x01,0x01 USB Streaming
	0x0C,0x24,0x02,0x01,0x01,0x01,0x00,0x02,0x03,0x00,0x00,0x00,//for speaker
	//No2:SType Feature;No3:UnitID;No4:SourceID
	0x0A,0x24,0x06,0x02,0x01,0x01,0x01,0x02,0x02,0x00,//for Spearker
	//No2:SType Output;No3:TerminalID;No4~5:Type Speaker
	0x09,0x24,0x03,0x03,0x01,0x03,0x00,0x02,0x00,//for Speaker
	//No3：TerminalID;No4~5:Type 0x01,0x02 microphone/0x03,0x02 Personal Microphone
	//0x0C,0x24,0x02,0x04,0x01,0x02,0x00,0x02,0x03,0x00,0x00,0x00,
	0x0C,0x24,0x02,0x04,0x03,0x02,0x00,0x02,0x03,0x00,0x00,0x00, //for mic
	//No2:SType Feature;No3:UnitID;No4:SourceID
	0x0A,0x24,0x06,0x05,0x04,0x01,0x01,0x02,0x02,0x00,//for Mic
	//No2:SType Selector;No4:SourceID
	0x07,0x24,0x05,0x06,0x01,0x05,0x00,//for mic
	//No2：SType Output;No3：TerminalID;TerminalType:USB Streaming;No7:SourceID
	0x09,0x24,0x03,0x07,0x01,0x01,0x00,0x06,0x00,//for Mic

	//1 audio stream Interface, speaker
	//No2:INTERFACENUM;No3:AltSet;No4:numendpoint;
	0x09,0x04,0x01,0x00,0x00,0x01,0x02,0x00,0x00,
	0x09,0x04,0x01,0x01,0x01,0x01,0x02,0x00,0x00,
	0x07,0x24,0x01,0x01,0x01,0x01,0x00,
	//No4 = Speaker channel; No7 = Total; No8~13:Samplerate
	0x0E,0x24,0x02,0x01,0x02,0x02,0x10,0x02,0x44,0xAC, 0x00,0x80,0xBB, 0x00,
	//No1:Type Endpoint;No3:Attr Transfer:ISO;
	0x09, 0x05, DEVICE_ISO_OUT_EP, 0x09, DEVICE_FS_ISO_OUT_MPS, 0x00, 0x01, 0x00, 0x00,
	//No1:Type Cs_endpoint
	0x07,0x25,0x01,0x01,0x00,0x00,0x00,
	...
	0x07,0x24,0x01,0x07,0x01,0x01,0x00,
	//No4 = channel; No7 = Total; No8~10:Samplerate
	0x0E,0x24,0x02,0x01,MIC_CH,0x02,0x10,0x02,0x44,0xAC, 0x00,0x80,0xBB, 0x00,
	0x09, 0x05, DEVICE_ISO_IN_EP, 0x09, DEVICE_FS_ISO_IN_MPS, 0x00, 0x01, 0x00, 0x00,
	0x07,0x25,0x01,0x01,0x00,0x00,0x00,
	...
	0x09,0x21,0x01,0x02,0x00,0x01,0x22,sizeof(AudioCtrlReportDescriptor),0x00,
	//No1:Type Endpoint;No3:Attr Transfer;
	0x07,0x05,DEVICE_INT_IN_EP,0x03,DEVICE_FS_INT_IN_MPS,0x00,0x01,
#if HID_DATA_FUN_EN
	//No2:INTERFACENUM
...
//set Index @ XXX_INTERFACE_NUM && INTERFACENUM @ InterFaceNum_Tab
...
const uint8_t ConfigDescriptor_Tab(AUDIO_MIC_PHONE)[] =
{
	...
	//0x0B,0x24,0x02,0x01,MIC_CH,0x02,0x10,0x01,0x80,0x3E, 0x00,//0x80,0x3E, 0x00,
	0x09, 0x05, DEVICE_ISO_IN_EP, 0x09, DEVICE_FS_ISO_IN_MPS, 0x00, 0x01, 0x00, 0x00,
	0x07,0x25,0x01,0x01,0x00,0x00,0x00,
...
//MIDI
const uint8_t ConfigDescriptor_Tab(AUDIO_USB_MIDI)[] =
{
#if HID_DATA_FUN_EN
	//一共3个接口
	 0x09,0x02,0x77,0x00,0x03,0x01,0x00,0x80,0x32,
#else
	//一共2个接口
	...
	//1 midi stream Interface
     0x09,0x04,0x01,0x00,0x02,0x01,0x03,0x00,0x00,
		 ...
		 0x09,0x05,DEVICE_BULK_IN_EP,0x02,0x40,0x00,0x00,0x00,0x00,
		 0x05,0x25,0x01,0x01,0x03,
		 0x09,0x05,DEVICE_BULK_OUT_EP,0x02,0x40,0x00,0x00,0x00,0x00,
...
const uint8_t InterFaceNum_Tab(AUDIO_USB_MIDI)[] = {0xFF,0x00,0xFF,0xFF,0xFF,0x02};
...
const uint8_t *ConfigDescriptorTab[10] =
{
	...
	ConfigDescriptor_Tab(AUDIO_MIC_PHONE),
	ConfigDescriptor_Tab(AUDIO_USB_MIDI),
};

const uint8_t *InterFaceNumTab[10] =
{
	...
	InterFaceNum_Tab(AUDIO_MIC_PHONE),
	InterFaceNum_Tab(AUDIO_USB_MIDI),
};
