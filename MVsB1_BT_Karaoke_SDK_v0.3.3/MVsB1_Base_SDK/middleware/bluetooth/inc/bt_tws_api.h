...
#define TWS_IIS0_OUT	1
#define TWS_IIS1_OUT	2
#define TWS_DAC0_OUT	3

#ifdef CFG_RES_AUDIO_I2SOUT_EN
	#if (CFG_RES_I2S_PORT == 0)
	#define TWS_AUDIO_OUT_PATH	TWS_IIS0_OUT
	#else
	#define TWS_AUDIO_OUT_PATH	TWS_IIS1_OUT
	#endif
#else
	#define TWS_AUDIO_OUT_PATH	TWS_DAC0_OUT
#endif
...
//audio_quality
#define TWS_AUDIO_LOW		0//低码率
#define TWS_AUDIO_HIGH		1//高码率
uint32_t tws_mem_size(uint32_t delay,uint8_t audio_mode,uint8_t audio_quality);
