...
typedef struct
{
	uint8_t TWS_CONNECT_STATE_FLAG;
	uint8_t TWS_PHONE_CONNECT_FALG;
	uint8_t TWS_PARIE_KEY;
}TWS_BLE_FUC;
...
* 
*/
void TwsPeerBlePairingRegist(uint8_t type);

/*
* 
*/
void ble_adv_scan_set(void);

/*
* 
*/
void ble_only_adv_set(void);

/*
* 
*/
void ble_only_scan_set(void);

/*
* 
*/
void ble_adv_scan_disable(void);
