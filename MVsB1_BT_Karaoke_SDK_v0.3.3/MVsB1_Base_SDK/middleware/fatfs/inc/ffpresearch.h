...
#define MAX_FOLDER_NUM_SAVE 4096//DO NOT change
#define MAX_FOLDER_NUM_TABLE_LEN (MAX_FOLDER_NUM_SAVE/8)//DO NOT change
...
//返回值为TRUE时，过滤当前搜索到的文件。
typedef bool (*ff_file_filter_callback)(FILINFO *finfo);
...
void ffpresearch_filter_file_callback_set(ff_file_filter_callback bcb);

void ffpresearch_fattrib_set(BYTE attrib);
void ffpresearch_empty_folder_table_set(void *empty_folder_table);
#endif
