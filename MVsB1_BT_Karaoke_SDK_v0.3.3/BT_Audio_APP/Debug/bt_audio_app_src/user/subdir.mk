...
C_SRCS += \
../bt_audio_app_src/user/BT_BQB_Test.c \
../bt_audio_app_src/user/misc.c \
../bt_audio_app_src/user/soft_power.c \
../bt_audio_app_src/user/soft_watch_dog.c \
../bt_audio_app_src/user/usb_midi_demo.c 

OBJS += \
./bt_audio_app_src/user/BT_BQB_Test.o \
./bt_audio_app_src/user/misc.o \
./bt_audio_app_src/user/soft_power.o \
./bt_audio_app_src/user/soft_watch_dog.o \
./bt_audio_app_src/user/usb_midi_demo.o 

C_DEPS += \
./bt_audio_app_src/user/BT_BQB_Test.d \
./bt_audio_app_src/user/misc.d \
./bt_audio_app_src/user/soft_power.d \
./bt_audio_app_src/user/soft_watch_dog.d \
./bt_audio_app_src/user/usb_midi_demo.d 
