...
enum
{
	...
	USB_MIX_SOURCE_NUM,         //usb audio mix下行通道 
	#endif
...
#define USB_AUDIO_SOURCE_NUM  APP_SOURCE_NUM 		//usb audio 下行通道 
#endif
...
enum
{
	...
	AUDIO_I2S0OUT_SINK_NUM,      //i2s_out通道
	#endif
	#ifdef CFG_RES_AUDIO_I2S1OUT_EN
	AUDIO_I2S1OUT_SINK_NUM,      //i2s_out通道
	#endif
