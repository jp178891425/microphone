...
#define AppResourceFlash		BIT(13) //登记外置flash可用

#define AppResourceBtHf			BIT(14)

#define AppResourceBtRecord		BIT(15)

#define AppResourceRest			BIT(16)

#define AppResourceTwsSlave		BIT(17)
