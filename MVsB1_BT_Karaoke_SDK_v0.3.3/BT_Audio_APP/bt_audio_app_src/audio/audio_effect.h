...
#define  CFG_AUDIO_EFFECT_MIC_BLUENS_SUPPRESSOR_EN		 (0)
...
#define  CFG_AUDIO_EFFECT_HFP_NS_EN	                     (1)//目前只支持8K,16K采样率
#else
#define  CFG_AUDIO_EFFECT_MIC_AEC_EN	                 (0)//目前只支持8K,16K采样率
#define  CFG_AUDIO_EFFECT_HFP_NS_EN	                     (0)//目前只支持8K,16K采样率
#endif
#define  CFG_AUDIO_EFFECT_MIC_NOISE_SUPPRESSOR_EN	     (1)
#define  CFG_AUDIO_EFFECT_MIC_FREQ_SHIFTER_EN            (1)
#define  CFG_AUDIO_EFFECT_MIC_FREQ_SHIFTER_FINE_EN       (0)
#define  CFG_AUDIO_EFFECT_MIC_HOWLING_DECTOR_EN          (1)
#define  CFG_AUDIO_EFFECT_MIC_HOWLING_DECTOR_FINE_EN     (1)
...
#define  CFG_AUDIO_EFFECT_MIC_ECHO_24BIT_EN				 (0)//0=(16bit echo), 1=(24bit echo)
...
#define  CFG_AUDIO_EFFECT_CHORUS2_EN                     (0)
...
#define  CFG_AUDIO_EFFECT_OVERDRIVER_EN                  (0)
#define  CFG_AUDIO_EFFECT_OVERDRIVER_POLY_EN             (0)
#define  CFG_AUDIO_EFFECT_DISTORTION_EN                  (0)
#define  CFG_AUDIO_EFFECT_DISTORTION_DS1_EN              (0)
#define  CFG_AUDIO_EFFECT_PITCH_DECTOR_EN                (0)
...
#define  CFG_AUDIO_EFFECT_DISTORTION_DS1_EN              (0)
#define  CFG_AUDIO_EFFECT_PITCH_DECTOR_EN                (0)
#define  CFG_AUDIO_EFFECT_MIC_HOWLING_DECTOR_FINE_EN     (0)
#endif
#define  CFG_AUDIO_EFFECT_EQ_DRC_STRUCT_EN               (1)
#define  CFG_AUDIO_EFFECT_COMPANDER_EN                   (1)
#define  CFG_AUDIO_EFFECT_LOW_LEVEL_COMPRESSOR_EN        (1)
#define  CFG_AUDIO_EFFECT_BIQUAD_EN                      (0)
#define  CFG_AUDIO_EFFECT_HOWLING_GUARD_EN               (1)
#define  CFG_AUDIO_EFFECT_PHASE_SHIFTER_EN               (0)
#define  CFG_AUDIO_EFFECT_DRAPOST_EN                     (0)
#define  CFG_AUDIO_EFFECT_DC_BLOCKER_EN                  (0)
#define  CFG_AUDIO_EFFECT_VIRTUAL_SURROUND_EN                 (0)
#define  CFG_AUDIO_EFFECT_NOISE_GENERATOR_EN             (0)
#define  CFG_AUDIO_EFFECT_BUTTERWORTH_EN                 (0)
#define  CFG_AUDIO_EFFECT_DYNAMIC_EQ_EN                  (1)
#define  CFG_AUDIO_EFFECT_LRBALANCER_EN                  (0)
#define  CFG_AUDIO_EFFECT_MIC_HOWLING_SPECIFIED_EN       (1)
#define  CFG_AUDIO_EFFECT_VAD_EN                         (0)
#define  CFG_AUDIO_EFFECT_DRC_LEGACY_EN				 	 (1)
...
#define CFG_PARA_PITCH_DECT_SAMPLES_PER_FRAME           (  2048)  //unit in sample
...
#define CFG_MIC_AEC_ES_LEVEL                            (   5)   //0: off, 1: minimum suppression, ..., 5: maximum suppression.
#define CFG_MIC_AEC_NS_LEVEL                            (   4)   //0: off, 1: minimum suppression, ..., 5: maximum suppression.
